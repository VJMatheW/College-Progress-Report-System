<%-- 
    Document   : UploadSubjectCode
    Created on : 29 Jun, 2017, 4:24:23 PM
    Author     : vijay_ravi
--%>
...
<html>
    <head>
        ...
        <title>Upload Subject Code</title>
        <style type="text/css">
            #msg{
                color:red;
            }
    ...
    <body>
        ...
        %>
        <h2><b>Upload Dept Subjects Code</b><hr style="border-color: black;"/></h2> 
        <div class="container-fluid" >
            <div class="col-sm-6">
                <form class="form-horizontal" action="../../UploadSubjects" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="type" value="subcode">
            ...
            <div class="col-sm-6">                
                <%
                    String tbody="";
                    Map<String,String> content = Components.fetchSemSubjectCodeORName("subCode");
